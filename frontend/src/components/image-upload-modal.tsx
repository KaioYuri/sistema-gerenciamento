    ...
    <Dialog>
      <DialogTrigger>
        <div className="bg-black text-white flex items-center py-2 px-3 rounded-md hover:bg-opacity-80">
          <FiUpload size="1.2em" />
          <span className="ml-2 text-sm">Carregar Imagem</span>
        </div>
      </DialogTrigger>
      <DialogContent>
        <DialogHeader>
          <DialogTitle className=" mb-3">Carregar Imagem</DialogTitle>
              ...
              {!loading && !uploadedImagePath && (
                <div className=" text-center">
                  ...
                  <p className="text-xs text-gray-400 dark:text-gray-400">
                    Clique para carregar &#40; imagem deve ter 500x500 px e abaixo de 10 
                    MB &#41;
                  </p>
                </div>
              )}
              ...
              {uploadedImagePath && !loading && (
                <div className="text-center">
                  <Image
                    ...
                    alt="uploaded image"
                  />
                  <p className=" text-sm font-semibold">Imagem carregada</p>
                  <p className=" text-xs text-gray-400">
                    Clique para submeter a imagem.
                  </p>
                </div>
              )}
            </label>
